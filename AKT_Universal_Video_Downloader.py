...
async def capture_post(url: str):
    ...
    if not is_twitter and not is_instagram:
        ...
        print("[+] Universal video download enabled for this URL.")
        downloaded = download_videos_for_url(
            url, platform, username, timestamp_str, cookies=cookies
        )
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            if is_twitter:
                ...
                downloaded = download_videos_for_url(
                    url, "x", tw_username, timestamp_str, cookies=cookies
                )
                if not downloaded and target_url != url:
                    downloaded = download_videos_for_url(
                        target_url, "x", tw_username, timestamp_str, cookies=cookies
                    )
...
if __name__ == "__main__":
    try:
        ...
        print("\n" + "=" * 60)
        print("AKT UNIVERSAL SOCIAL MEDIA SNAPSHOTTER + VIDEO DOWNLOADER")
