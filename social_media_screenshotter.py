...
# Share TOOLS_DIR with the repaired video engine (Deno install path).
import video_download_engine as _vde
_vde.TOOLS_DIR = TOOLS_DIR

from video_download_engine import (
    detect_platform,
    ensure_deno_runtime,
    ensure_video_dependencies,
    get_browser_cookies_for_domain,
    is_downloadable_url,
    platform_username_from_url,
    run_yt_dlp_download,
)
